...
SOURCE_CATALOG: dict[str, SourceEntry] = {
    ...
    "global_quake": SourceEntry(
        ...
        description="PancakesAPI 聚合推送中的 Global Quake 全球地震实时数据",
        ...
        connection_url="wss://api.aloys23.link/api/v1/alert/ws/all",
    ...
    # jma_pancakes: 日本气象厅紧急地震速报 - 来自 PancakesAPI
    "jma_pancakes": SourceEntry(
        source_id="jma_pancakes",
        source_enum="pancakes_jma_eew",
        source_type=SourceType.EARTHQUAKE_WARNING,
        provider_family=ProviderFamily.GLOBAL_QUAKE,
        config_group="pancakes_api",
        config_key="japan_jma_eew",
        ...
        default_timezone="Asia/Tokyo",
        publish_time_field="announced_time",
        report_num_field="report_num",
        fingerprint_prefix="jma_pc",
        connection_group="pancakes_api",
        connection_handler="pancakes_api",
        connection_data_source="pancakes_mixed",
        connection_url="wss://api.aloys23.link/api/v1/alert/ws/all",
        dispatch_family="pancakes_jma_eew",
        provider_source_names=("jma_eew",),
        provider_aliases=("pancakes_jma_eew", "pancakes_jma"),
        routing_tags=("pancakes", "openquake", "japan", "eew", "jma"),
    ),
    # jma_eqlist_pancakes: 日本气象厅地震情报 - 来自 PancakesAPI
    "jma_eqlist_pancakes": SourceEntry(
        source_id="jma_eqlist_pancakes",
        source_enum="pancakes_jma_eqlist",
        source_type=SourceType.EARTHQUAKE_INFO,
        provider_family=ProviderFamily.GLOBAL_QUAKE,
        config_group="pancakes_api",
        config_key="japan_jma_earthquake",
        parser_name="jma_eqlist_pancakes_parser",
        presentation_type="earthquake_report",
        ...
        default_timezone="Asia/Tokyo",
        publish_time_field="announced_time",
        fingerprint_prefix="jma_eq_pc",
        connection_group="pancakes_api",
        connection_handler="pancakes_api",
        connection_data_source="pancakes_mixed",
        connection_url="wss://api.aloys23.link/api/v1/alert/ws/all",
        dispatch_family="pancakes_jma_eqlist",
        provider_source_names=("jma_eqlist", "eqlist"),
        provider_aliases=("pancakes_jma_eqlist", "pancakes_eqlist"),
        routing_tags=("pancakes", "openquake", "japan", "earthquake", "jma", "eqlist"),
    ),
    # usgs_pancakes: 美国地质调查局地震测定 - 来自 PancakesAPI
    "usgs_pancakes": SourceEntry(
        source_id="usgs_pancakes",
        source_enum="pancakes_usgs",
        source_type=SourceType.EARTHQUAKE_INFO,
        provider_family=ProviderFamily.GLOBAL_QUAKE,
        config_group="pancakes_api",
        config_key="usgs_earthquake",
        parser_name="usgs_pancakes_parser",
        presentation_type="earthquake_report",
        ...
        default_timezone="UTC",
        publish_time_field="occurred_at",
        fingerprint_prefix="usgs_pc",
        connection_group="pancakes_api",
        connection_handler="pancakes_api",
        connection_data_source="pancakes_mixed",
        connection_url="wss://api.aloys23.link/api/v1/alert/ws/all",
        dispatch_family="pancakes_usgs",
        provider_source_names=("usgs",),
        provider_aliases=("pancakes_usgs",),
        routing_tags=("pancakes", "openquake", "usgs", "earthquake", "global"),
    ),
    ...
    # ---------------------------------------------------------------------------
    # Jian Project WebSocket 聚合源 (api.sismotide.top)
    # 仅单连接 /all，按协议限定接入 7 大核心数据源
    # ---------------------------------------------------------------------------
    "cea_jianproject": SourceEntry(
        source_id="cea_jianproject",
        source_enum="jian_project_cea",
        source_type=SourceType.EARTHQUAKE_WARNING,
        provider_family=ProviderFamily.JIAN_PROJECT,
        config_group="jian_project",
        config_key="china_earthquake_warning",
        parser_name="china_eew_parser",
        presentation_type="earthquake_eew",
        text_presenter_key="cea_eew",
        ...
        priority=2,
        display_name="中国地震预警网",
        description="中国地震预警网（CEA）- Jian Project WebSocket",
        default_timezone="Asia/Shanghai",
        publish_time_field="originTime",
        report_num_field="number",
        fingerprint_prefix="cea",
        connection_group="jian_project_all",
        connection_handler="jian_project",
        connection_data_source="jian_project_mixed",
        connection_url="wss://api.sismotide.top/all",
        institution_key="china",
        institution_display_name="中国地震预警网 EEW",
        institution_active_name="中国地震预警网",
        query_group="eew",
        dispatch_family="jian_project_eew",
        provider_source_names=("cea",),
        provider_aliases=("jian_project_cea", "cea"),
        routing_tags=("jian_project", "china", "eew"),
    ),
    "cwa_jianproject": SourceEntry(
        source_id="cwa_jianproject",
        source_enum="jian_project_cwa",
        source_type=SourceType.EARTHQUAKE_WARNING,
        provider_family=ProviderFamily.JIAN_PROJECT,
        config_group="jian_project",
        config_key="taiwan_cwa_earthquake",
        ...
        priority=2,
        display_name="台湾中央气象署（地震预警）",
        description="台湾中央气象署地震预警（CWA）- Jian Project WebSocket",
        default_timezone="Asia/Taipei",
        publish_time_field="originTime",
        report_num_field="number",
        fingerprint_prefix="cwa",
        ...
        dispatch_family="jian_project_eew",
        provider_source_names=("cwa-eew",),
        provider_aliases=("jian_project_cwa", "cwa-eew"),
        routing_tags=("jian_project", "taiwan", "eew"),
    ),
    "jma_jianproject": SourceEntry(
        source_id="jma_jianproject",
        source_enum="jian_project_jma",
        source_type=SourceType.EARTHQUAKE_WARNING,
        provider_family=ProviderFamily.JIAN_PROJECT,
        config_group="jian_project",
        config_key="japan_jma_eew",
        ...
        priority=2,
        display_name="日本气象厅（紧急地震速报）",
        description="日本气象厅：紧急地震速报 - Jian Project WebSocket",
        default_timezone="Asia/Tokyo",
        publish_time_field="originTime",
        report_num_field="serial",
        fingerprint_prefix="jma",
        connection_group="jian_project_all",
        connection_handler="jian_project",
        connection_data_source="jian_project_mixed",
        ...
        query_group="eew",
        dispatch_family="jian_project_eew",
        provider_source_names=("jma-eew",),
        provider_aliases=("jian_project_jma", "jma-eew"),
        routing_tags=("jian_project", "japan", "eew"),
    ),
    "china_weather_jianproject": SourceEntry(
        source_id="china_weather_jianproject",
        source_enum="jian_project_weather",
        source_type=SourceType.WEATHER,
        provider_family=ProviderFamily.JIAN_PROJECT,
        config_group="jian_project",
        config_key="china_weather_alarm",
        ...
        priority=2,
        display_name="中国气象局（气象预警）",
        description="中国气象局气象预警 - Jian Project WebSocket",
        default_timezone="Asia/Shanghai",
        publish_time_field="originTime",
        fingerprint_prefix="cn_weather",
        connection_group="jian_project_all",
        ...
        connection_data_source="jian_project_mixed",
        connection_url="wss://api.sismotide.top/all",
        dispatch_family="jian_project_weather",
        provider_source_names=("weather",),
        provider_aliases=("jian_project_weather", "weather"),
        routing_tags=("jian_project", "china", "weather"),
    ),
    "china_tsunami_jianproject": SourceEntry(
        source_id="china_tsunami_jianproject",
        source_enum="jian_project_tsunami",
        source_type=SourceType.TSUNAMI,
        provider_family=ProviderFamily.JIAN_PROJECT,
        config_group="jian_project",
        config_key="china_tsunami",
        ...
        priority=2,
        display_name="自然资源部海啸预警中心",
        description="自然资源部海啸预警中心海啸预警信息 - Jian Project WebSocket",
        default_timezone="Asia/Shanghai",
        publish_time_field="originTime",
        fingerprint_prefix="cn_tsunami",
        connection_group="jian_project_all",
        ...
        connection_data_source="jian_project_mixed",
        connection_url="wss://api.sismotide.top/all",
        dispatch_family="jian_project_tsunami",
        provider_source_names=("nmefc-tsunami",),
        provider_aliases=("jian_project_tsunami", "nmefc-tsunami"),
        routing_tags=("jian_project", "china", "tsunami"),
    ),
    "cenc_jianproject": SourceEntry(
        source_id="cenc_jianproject",
        source_enum="jian_project_cenc",
        source_type=SourceType.EARTHQUAKE_INFO,
        provider_family=ProviderFamily.JIAN_PROJECT,
        config_group="jian_project",
        config_key="china_cenc_earthquake",
        ...
        priority=2,
        display_name="中国地震台网（地震情报）",
        description="中国地震台网（CENC）：地震测定 - Jian Project WebSocket",
        default_timezone="Asia/Shanghai",
        publish_time_field="originTime",
        fingerprint_prefix="cenc",
        connection_group="jian_project_all",
        ...
        fusion_group="cenc_intensity",
        fusion_role=FusionRole.SECONDARY,
        dispatch_family="jian_project_report",
        provider_source_names=("cenc",),
        provider_aliases=("jian_project_cenc", "cenc"),
        routing_tags=("jian_project", "china", "report"),
    ),
    "usgs_jianproject": SourceEntry(
        source_id="usgs_jianproject",
        source_enum="jian_project_usgs",
        source_type=SourceType.EARTHQUAKE_INFO,
        provider_family=ProviderFamily.JIAN_PROJECT,
        config_group="jian_project",
        config_key="usgs_earthquake",
        ...
        priority=2,
        display_name="美国地质调查局",
        description="美国地质调查局（USGS）：地震测定 - Jian Project WebSocket",
        default_timezone="UTC",
        publish_time_field="originTime",
        fingerprint_prefix="usgs",
        connection_group="jian_project_all",
        ...
        dispatch_family="jian_project_report",
        provider_source_names=("usgs",),
        provider_aliases=("jian_project_usgs", "usgs"),
        routing_tags=("jian_project", "global", "report"),
    ),
}
